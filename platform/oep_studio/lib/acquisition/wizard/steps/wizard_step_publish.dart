      ...
      child: Column(
        ...
        children: [
          ...
          if (!published)
            ...
            const _StatusLine('Candidate Objects Created', false,
                detail: 'Not generated by this wizard -- run ingestion to generate candidates'),
            const _StatusLine('Ready for Ingestion', true,
                detail: 'Use "Ingest into Knowledge Studio" on the Reference Vault panel to continue'),
