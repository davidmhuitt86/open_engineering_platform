...
function hideCtx() { $('ctx').classList.remove('open'); $('ctx-edit').style.display = ''; $('ctx-edit').textContent = '✎ Edit Wire Props'; $('ctx-trace').style.display = ''; $('ctx-del').textContent = '✕ Delete Wire'; ctxTarget = null; }
