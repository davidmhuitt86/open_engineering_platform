...
class _ReasoningDashboardPageState extends ConsumerState<ReasoningDashboardPage> {
  ...
  ///
  /// WP-EKE-FOLLOWUP-001: a genuine execution gate — [_createAndRun]
  /// must not call `createReasoningSession`/`executeReasoning` unless
  /// this returns `true`. Only [EkeReadinessState.ready] returns `true`
  /// — see [EkeConsumerGate].
