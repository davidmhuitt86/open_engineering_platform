...
void main() {
  const trustedEntry = 'file:///C:/dev/open_engineering_platform/reference/legacy_wiring_sim_v2/eke-wiring-sim/index.html';
  ...
  test('another file within the same V2 directory is trusted', () {
    const sibling = 'file:///C:/dev/open_engineering_platform/reference/legacy_wiring_sim_v2/eke-wiring-sim/js/app.js';
  ...
  test('a different local file outside the V2 directory is NOT trusted', () {
    const outside = 'file:///C:/dev/open_engineering_platform/reference/some_other_app/index.html';
