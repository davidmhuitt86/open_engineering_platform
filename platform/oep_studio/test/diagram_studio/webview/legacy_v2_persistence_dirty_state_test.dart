  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(controller.isDirty, isFalse,
          reason: 'a fresh bootstrapped document starts clean');
      ...
      expect(controller.isDirty, isTrue,
          reason:
              'a bridged mutation must dirty the document like any other edit');
      ...
      await legacyV2PersistenceSettle(tester);
      expect(controller.isDirty, isTrue,
          reason: 'undo is itself a mutation relative to the saved state');
      ...
      expect(controller.isDirty, isFalse,
          reason:
              'a freshly reloaded document must be clean regardless of prior dirty state');
